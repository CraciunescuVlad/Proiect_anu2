...
//                    String numePacient = parts[1];
//                    String numeDoctor = parts[2];
//                    LocalDateTime data = LocalDateTime.parse(parts[3], formatter);
//                    String interval = parts[4];
//                    boolean efectuata = Boolean.parseBoolean(parts[5]);
//                    programari.add(new Programare(id, numeDoctor, numePacient, data, interval, efectuata));
//                } catch (Exception e) {
